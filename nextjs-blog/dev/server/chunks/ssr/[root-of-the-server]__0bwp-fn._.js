...
function getSortedPostsData() {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, 'posts.json');
    const jsonString = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(filePath, 'utf8');
...
async function getStaticProps({ params }) {
    ...
    const postData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$posts$2d$json$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getPostData"])(params.id);
    return {
        props: {
            postData
        }
...
async function getStaticPaths() {
    const paths = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$posts$2d$json$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllPostIds"])();
    return {
        paths,
        fallback: false
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bwp-fn._.js.map